...
VERSION_PATH = os.path.join("honahlee", "VERSION.txt")
...
setup(
    ...
    author="Volund",
    maintainer="Volund",
    url="https://github.com/volundmush/honahlee",
    ...
    python_requires=">=3.8",
    project_urls={
        "Source": "https://github.com/volundmush/honahlee",
        "For": "https://github.com/evennia/evennia",
        "Issue tracker": "https://github.com/volundmush/honahlee/issues",
